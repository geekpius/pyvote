...
const getCashTransactionTable = url => {
    $.ajax({
        url: url,
        type: "GET",
...
getCashTransactionTable($(".table-responsive").data('href'));


// reload all transaction
$(".btnReload").on("click", function(e){
    e.preventDefault();
    var $this = $(this);
    getCashTransactionTable($this.data("href"));
    return false;
});
...
// filter this month transaction
$(".btnThisMonth").on("click", function(e){
    e.preventDefault();
    var $this = $(this);
    getCashTransactionTable($this.data("href"));
    return false;
...
// filter this year transaction
$(".btnThisYear").on("click", function(e){
    e.preventDefault();
    var $this = $(this);
    getCashTransactionTable($this.data("href"));
    return false;
